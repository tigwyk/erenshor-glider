...
public class Condition
{
    ...
    public bool Evaluate(CombatState combatState, PlayerVitals vitals, BuffState playerBuffs, BuffState? targetBuffs, TargetInfo? target)
    {
        return Type switch
        {
            ...
            ConditionType.TargetHealthPercent => target != null && target.HasTarget && Compare(target.HealthPercent, Value, Operator),
            ConditionType.TargetExists => target != null && target.HasTarget,
            ConditionType.TargetIsHostile => target != null && target.IsHostile,
            ConditionType.TargetIsDead => target != null && target.IsDead,
